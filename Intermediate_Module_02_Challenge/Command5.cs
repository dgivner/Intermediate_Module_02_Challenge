...
namespace Intermediate_Module_02_Challenge
{
    ...
    internal class Command5 : IExternalCommand
    {
        ...
        internal static PushButtonData GetButtonData()
        {
            ...
            string buttonInternalName = "btnComman5";
            string buttonTitle = "Area Tags";

            ButtonDataClass myButtonData5 = new ButtonDataClass(
                buttonInternalName,
                buttonTitle,
